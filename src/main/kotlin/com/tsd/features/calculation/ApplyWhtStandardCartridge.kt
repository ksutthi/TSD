...
class ApplyWhtStandardCartridge(
    ...
    override fun execute(packet: ExchangePacket, context: ExecutionContext) {
        ...
        if (accountId != null) {
            // 🔑 CRITICAL CHANGE: Use 'memory.getActiveJobId()' instead of 'context.getEventID()'
    ...
    override fun initialize(context: ExecutionContext) { memory.clearJob(context.getEventID()) }
